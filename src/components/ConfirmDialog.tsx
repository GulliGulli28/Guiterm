...
interface ConfirmDialogProps {
  title: string;
  message: string;
  /** Un choix à faire avant de confirmer (une case à cocher) — rendu sous le
   * message, donc à l'intérieur du piège à focus, là où il est cliquable. */
  children?: ReactNode;
  confirmLabel?: string;
  cancelLabel?: string;
  danger?: boolean;
...
export function ConfirmDialog({ title, message, children, confirmLabel = "Confirmer", cancelLabel = "Annuler", danger, onConfirm, onCancel }: ConfirmDialogProps) {
