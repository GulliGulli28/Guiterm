  ...
  render() {
    ...
    return (
      <div className="flex h-screen w-screen flex-col items-center justify-center gap-4 bg-[var(--c-bg)] p-8 text-[var(--c-text)]">
        <div className="w-full max-w-2xl space-y-4 modal p-6">
          <h1 className="text-[15px] font-semibold">Une erreur inattendue s'est produite</h1>
          ...
          <pre className="max-h-64 overflow-auto rounded-md bg-[var(--c-bg3)] p-3 text-[11px] leading-relaxed text-[var(--c-danger)]">
            {this.report()}
          </pre>
